// Página 46 - Exercícios Enquanto A - L
...
function tabuada() {
  let multiplicando = Number(prompt("Digite um número para saber a tabuada!"));
...
while (valor >= 0) {
  valor = parseInt(prompt('Digite um valor positivo (ou negativo para parar): '));
